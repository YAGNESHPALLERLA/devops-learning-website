  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
        ...
        <div 
          className="relative rounded-xl p-6 card-hover-effect hover-glow-soft cursor-pointer overflow-hidden"
          style={{
          ...
          onMouseEnter={(e) => {
            e.currentTarget.style.background = 'linear-gradient(135deg, rgba(122, 148, 165, 0.25) 0%, rgba(8, 61, 119, 0.15) 100%)';
            e.currentTarget.style.borderColor = 'rgba(8, 61, 119, 0.5)';
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.background = 'linear-gradient(135deg, rgba(122, 148, 165, 0.12) 0%, rgba(8, 61, 119, 0.08) 100%)';
        ...
        >
          ...
          <div className="flex flex-col h-full relative z-10">
            <div className="flex items-start gap-4 mb-4">
              <div 
                className="flex-shrink-0 w-14 h-14 rounded-xl flex items-center justify-center transition-all duration-300 relative overflow-hidden group/icon"
                style={{
            ...
            <ul className="space-y-2 mb-4 flex-1">
              {[
                ...
                <li key={index} className="flex items-center text-xs" style={{ color: 'var(--text-secondary)' }}>
                  <svg className="w-4 h-4 mr-2 flex-shrink-0" style={{ color: '#7A94A5' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <Link 
              ...
              className="inline-flex items-center justify-center w-full text-sm font-semibold px-5 py-3 rounded-lg transition-all duration-300 relative overflow-hidden group/btn"
              style={{ 
                background: 'linear-gradient(135deg, #083D77 0%, #7A94A5 100%)',
                color: '#EBEBD3',
                boxShadow: '0 4px 15px rgba(8, 61, 119, 0.3)',
