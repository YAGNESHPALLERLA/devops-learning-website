            ...
            {milestones.map((milestone, index) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Content Card */}
                  <div
                    className={`glass rounded-xl p-5 transition-all duration-300 cursor-pointer hover-lift hover-glow w-full ${
                      isActive ? 'shadow-2xl' : ''
                    }`}
                    style={{
                  ...
                  >
                    <div className="flex flex-col items-center text-center h-full">
                      ...
                      <p 
                        ...
                        style={{ 
                          color: isActive ? 'rgba(235, 235, 211, 0.9)' : 'var(--text-secondary)',
                        }}
                      >
