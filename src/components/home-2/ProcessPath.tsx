...
export default function ProcessPath() {
  ...
  return (
    <section className="compact-section py-4" style={{ backgroundColor: 'var(--bg-secondary)' }}>
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-start max-w-6xl mx-auto">
          ...
          <ScrollAnimate animation="fade-up" triggerOnce={false}>
            <div className="relative">
              ...
              <div className="relative w-full aspect-[3/2] rounded-lg overflow-hidden glass hover-lift max-w-md">
                <Image
                  src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=600&h=400&fit=crop"
                  alt="Professionals collaborating"
                  fill
                  className="object-cover kenburns-top"
                ...
                {steps.map((step, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {/* Content Card */}
                        <div
                          className={`glass rounded-lg p-3 transition-all duration-300 cursor-pointer hover-lift hover-glow ${
                            isActive ? 'scale-105 shadow-xl' : ''
                          }`}
                          style={{
                            backgroundColor: isActive 
                              ? '#7A94A5' 
                              : 'rgba(122, 148, 165, 0.15)',
                            border: isActive 
                              ? '2px solid #083D77' 
                          ...
                          <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1">
                              ...
                              <p 
                                ...
                                style={{ 
                                  color: isActive ? 'rgba(235, 235, 211, 0.95)' : 'var(--text-secondary)',
                                  fontSize: '0.7rem'
                                }}
                              >
                                {step.description}
