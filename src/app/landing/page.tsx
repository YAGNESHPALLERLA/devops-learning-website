          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              <div>
                <div className="flex items-center space-x-3 mb-6">
                  ...
                  <div>
                    <h1 className="text-4xl font-bold text-white">OneHubGlobal</h1>
                    <p className="text-gray-400">Your Gateway to DevOps Excellence</p>
                  </div>
                </div>
                <h2 className="text-5xl font-bold text-white mb-4">
                  Master DevOps <span className="text-transparent bg-clip-text bg-gradient-to-r from-rose-400 to-purple-500">From Zero to Hero</span>
                </h2>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-[#1a1a1a] border border-gray-700 rounded-xl p-4">
                  ...
                  <h3 className="text-white font-semibold mb-1">Comprehensive Courses</h3>
                  <p className="text-gray-400 text-sm">Learn from basics to advanced</p>
                </div>
                <div className="bg-[#1a1a1a] border border-gray-700 rounded-xl p-4">
                  <Users className="w-8 h-8 text-blue-400 mb-2" />
                  <h3 className="text-white font-semibold mb-1">Expert Community</h3>
                ...
                <div className="bg-[#1a1a1a] border border-gray-700 rounded-xl p-4">
                  ...
                  <h3 className="text-white font-semibold mb-1">Job Portal</h3>
              ...
              <div className="bg-[#1a1a1a] border border-gray-700 rounded-xl p-6">
                ...
                <div className="flex flex-wrap gap-3">
                  {['Linux', 'Docker', 'Kubernetes', 'CI/CD', 'AWS', 'Azure', 'Terraform', 'Ansible'].map((tech) => (
                    <span key={tech} className="px-4 py-2 bg-[#252525] border border-gray-600 rounded-lg text-gray-300 text-sm">
                      {tech}
                    </span>
                  ))}
                </div>
            ...
            <div className="bg-[#1a1a1a] border border-gray-700 rounded-2xl shadow-2xl p-8">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-400">Create your free account to access all features</p>
              </div>
