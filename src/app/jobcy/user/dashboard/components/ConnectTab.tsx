...
export default function ConnectTab({ connections, isDark = false }: ConnectTabProps) {
  ...
  const fetchConnectionData = async () => {
    ...
    try {
      ...
      const receivedRes = await fetch(`${"/api/jobcy-backend"}/connections/received`, {
      ...
      // Fetch sent requests
      const sentRes = await fetch(`${"/api/jobcy-backend"}/connections/sent`, {
        headers: { Authorization: `Bearer ${token}` }
      });
      if (sentRes.ok) {
      ...
      const connectionsRes = await fetch(`${"/api/jobcy-backend"}/connections/connections`, {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const handleConnect = async (connection: Connection) => {
    ...
    try {
      const response = await fetch(`${"/api/jobcy-backend"}/connections/send`, {
        method: "POST",
        headers: {
  ...
  const handleAcceptRequest = async (requestId: string) => {
    ...
    try {
      const response = await fetch(`${"/api/jobcy-backend"}/connections/${requestId}/accept`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
  ...
  const handleRejectRequest = async (requestId: string) => {
    ...
    try {
      const response = await fetch(`${"/api/jobcy-backend"}/connections/${requestId}/reject`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
