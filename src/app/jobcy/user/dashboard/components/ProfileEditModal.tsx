...
function EducationForm({ education, onSave, onCancel, isDark = false }: EducationFormProps) {
  ...
  // Institution options - Comprehensive list from all states
  const institutionOptions: DropdownOption[] = [
    ...
    { value: "Osmania Medical College", label: "Osmania Medical College (TELANGANA)" },
    { value: "Gandhi Medical College", label: "Gandhi Medical College (TELANGANA)" },
    { value: "Kakatiya Medical College", label: "Kakatiya Medical College (TELANGANA)" },
    { value: "Deccan College of Medical Sciences", label: "Deccan College of Medical Sciences (TELANGANA)" },
    { value: "Mamata Medical College", label: "Mamata Medical College (TELANGANA)" },
    { value: "Malla Reddy Medical College for Women", label: "Malla Reddy Medical College for Women (TELANGANA)" },
    { value: "Apollo Institute of Medical Sciences and Research", label: "Apollo Institute of Medical Sciences and Research (TELANGANA)" },
    { value: "Kamineni Institute of Medical Sciences", label: "Kamineni Institute of Medical Sciences (TELANGANA)" },
    { value: "MNR Medical College and Hospital", label: "MNR Medical College and Hospital (TELANGANA)" },
    { value: "Prathima Institute of Medical Sciences", label: "Prathima Institute of Medical Sciences (TELANGANA)" },
    { value: "Shadan Institute of Medical Sciences", label: "Shadan Institute of Medical Sciences (TELANGANA)" },
    { value: "SVS Medical College", label: "SVS Medical College (TELANGANA)" },
    
    // Telangana Pharmacy Colleges
    { value: "University College of Pharmaceutical Sciences", label: "University College of Pharmaceutical Sciences (TELANGANA)" },
    { value: "St. Peter's Institute of Pharmaceutical Sciences", label: "St. Peter's Institute of Pharmaceutical Sciences (TELANGANA)" },
    { value: "Vijay Marie College of Pharmacy", label: "Vijay Marie College of Pharmacy (TELANGANA)" },
    { value: "Talla Padmavathi College of Pharmacy", label: "Talla Padmavathi College of Pharmacy (TELANGANA)" },
    { value: "Malla Reddy College of Pharmacy", label: "Malla Reddy College of Pharmacy (TELANGANA)" },
    { value: "Gokaraju Rangaraju College of Pharmacy", label: "Gokaraju Rangaraju College of Pharmacy (TELANGANA)" },
    { value: "Vignan Institute of Pharmaceutical Sciences", label: "Vignan Institute of Pharmaceutical Sciences (TELANGANA)" },
    { value: "Sree Dattha Institute of Pharmacy", label: "Sree Dattha Institute of Pharmacy (TELANGANA)" },
    { value: "Aurora's Pharmacy College", label: "Aurora's Pharmacy College (TELANGANA)" },
    { value: "Bharat Institute of Technology Pharmacy", label: "Bharat Institute of Technology Pharmacy (TELANGANA)" },
    { value: "CVR College of Pharmacy", label: "CVR College of Pharmacy (TELANGANA)" },
    { value: "Deccan School of Pharmacy", label: "Deccan School of Pharmacy (TELANGANA)" },
    { value: "Guru Nanak Institutions College of Pharmacy", label: "Guru Nanak Institutions College of Pharmacy (TELANGANA)" },
    { value: "Holy Mary Institute of Technology and Science Pharmacy", label: "Holy Mary Institute of Technology and Science Pharmacy (TELANGANA)" },
    { value: "Institute of Pharmaceutical Technology", label: "Institute of Pharmaceutical Technology (TELANGANA)" },
    { value: "JNTU College of Pharmacy", label: "JNTU College of Pharmacy (TELANGANA)" },
    { value: "Kakatiya Institute of Pharmaceutical Sciences", label: "Kakatiya Institute of Pharmaceutical Sciences (TELANGANA)" },
    { value: "Nalla Malla Reddy College of Pharmacy", label: "Nalla Malla Reddy College of Pharmacy (TELANGANA)" },
    { value: "Padmasri Dr. B.V. Raju Institute of Pharmacy", label: "Padmasri Dr. B.V. Raju Institute of Pharmacy (TELANGANA)" },
    { value: "Raghu College of Pharmacy", label: "Raghu College of Pharmacy (TELANGANA)" },
    { value: "Sreenidhi Institute of Pharmaceutical Sciences", label: "Sreenidhi Institute of Pharmaceutical Sciences (TELANGANA)" },
    { value: "Vasavi College of Pharmacy", label: "Vasavi College of Pharmacy (TELANGANA)" },
    { value: "Vignan's Institute of Pharmaceutical Sciences", label: "Vignan's Institute of Pharmaceutical Sciences (TELANGANA)" },
    { value: "Woxsen University School of Pharmacy", label: "Woxsen University School of Pharmacy (TELANGANA)" },
    
    // Telangana Management Colleges
    { value: "Institute of Public Enterprise", label: "Institute of Public Enterprise (TELANGANA)" },
    { value: "ICFAI Business School", label: "ICFAI Business School (TELANGANA)" },
    { value: "Symbiosis Institute of Business Management", label: "Symbiosis Institute of Business Management (TELANGANA)" },
    { value: "Woxsen School of Business", label: "Woxsen School of Business (TELANGANA)" },
    { value: "Amity Business School", label: "Amity Business School (TELANGANA)" },
    { value: "GITAM School of Business", label: "GITAM School of Business (TELANGANA)" },
    { value: "KL Business School", label: "KL Business School (TELANGANA)" },
    { value: "Manipal Academy of Higher Education", label: "Manipal Academy of Higher Education (TELANGANA)" },
    { value: "SRM School of Management", label: "SRM School of Management (TELANGANA)" },
    { value: "Vellore Institute of Technology Business School", label: "Vellore Institute of Technology Business School (TELANGANA)" },
    { value: "Birla Institute of Management Technology", label: "Birla Institute of Management Technology (TELANGANA)" },
    { value: "Chaitanya Bharathi Institute of Management", label: "Chaitanya Bharathi Institute of Management (TELANGANA)" },
    { value: "Gokaraju Rangaraju Institute of Management", label: "Gokaraju Rangaraju Institute of Management (TELANGANA)" },
    { value: "Institute of Management Technology", label: "Institute of Management Technology (TELANGANA)" },
    { value: "JNTU School of Management Studies", label: "JNTU School of Management Studies (TELANGANA)" },
    { value: "Keshav Memorial Institute of Management", label: "Keshav Memorial Institute of Management (TELANGANA)" },
    { value: "Malla Reddy Institute of Management", label: "Malla Reddy Institute of Management (TELANGANA)" },
    { value: "Nalla Malla Reddy Institute of Management", label: "Nalla Malla Reddy Institute of Management (TELANGANA)" },
    { value: "Padmasri Dr. B.V. Raju Institute of Management", label: "Padmasri Dr. B.V. Raju Institute of Management (TELANGANA)" },
    { value: "Raghu Institute of Management", label: "Raghu Institute of Management (TELANGANA)" },
    { value: "Sreenidhi Institute of Management", label: "Sreenidhi Institute of Management (TELANGANA)" },
    { value: "Vasavi Institute of Management", label: "Vasavi Institute of Management (TELANGANA)" },
    { value: "Vignan's Institute of Management", label: "Vignan's Institute of Management (TELANGANA)" },
    
    // Telangana Arts and Science Colleges
    { value: "St. Ann's College for Women", label: "St. Ann's College for Women (TELANGANA)" },
    { value: "St. Francis College for Women", label: "St. Francis College for Women (TELANGANA)" },
    { value: "St. Mary's College", label: "St. Mary's College (TELANGANA)" },
    { value: "Vivekananda Degree College", label: "Vivekananda Degree College (TELANGANA)" },
    { value: "Keshav Memorial Degree College", label: "Keshav Memorial Degree College (TELANGANA)" },
    { value: "Gokaraju Rangaraju Degree College", label: "Gokaraju Rangaraju Degree College (TELANGANA)" },
    { value: "Malla Reddy Degree College", label: "Malla Reddy Degree College (TELANGANA)" },
    { value: "Nalla Malla Reddy Degree College", label: "Nalla Malla Reddy Degree College (TELANGANA)" },
    { value: "Padmasri Dr. B.V. Raju Degree College", label: "Padmasri Dr. B.V. Raju Degree College (TELANGANA)" },
    { value: "Raghu Degree College", label: "Raghu Degree College (TELANGANA)" },
    { value: "Sreenidhi Degree College", label: "Sreenidhi Degree College (TELANGANA)" },
    { value: "Vasavi Degree College", label: "Vasavi Degree College (TELANGANA)" },
    { value: "Vignan's Degree College", label: "Vignan's Degree College (TELANGANA)" },
    { value: "Woxsen University Arts and Sciences", label: "Woxsen University Arts and Sciences (TELANGANA)" },
    { value: "Aurora's Degree College", label: "Aurora's Degree College (TELANGANA)" },
    { value: "Bharat Institute of Technology Arts and Sciences", label: "Bharat Institute of Technology Arts and Sciences (TELANGANA)" },
    { value: "CVR Degree College", label: "CVR Degree College (TELANGANA)" },
    { value: "Deccan College of Arts and Sciences", label: "Deccan College of Arts and Sciences (TELANGANA)" },
    { value: "Guru Nanak Institutions Degree College", label: "Guru Nanak Institutions Degree College (TELANGANA)" },
    { value: "Holy Mary Institute of Technology and Science Arts", label: "Holy Mary Institute of Technology and Science Arts (TELANGANA)" },
    { value: "Institute of Arts and Sciences", label: "Institute of Arts and Sciences (TELANGANA)" },
    { value: "JNTU College of Arts and Sciences", label: "JNTU College of Arts and Sciences (TELANGANA)" },
    { value: "Kakatiya Institute of Arts and Sciences", label: "Kakatiya Institute of Arts and Sciences (TELANGANA)" },
    { value: "Malla Reddy College of Arts and Sciences", label: "Malla Reddy College of Arts and Sciences (TELANGANA)" },
    { value: "Nalla Malla Reddy College of Arts and Sciences", label: "Nalla Malla Reddy College of Arts and Sciences (TELANGANA)" },
    { value: "Padmasri Dr. B.V. Raju College of Arts and Sciences", label: "Padmasri Dr. B.V. Raju College of Arts and Sciences (TELANGANA)" },
    { value: "Raghu College of Arts and Sciences", label: "Raghu College of Arts and Sciences (TELANGANA)" },
    { value: "Sreenidhi College of Arts and Sciences", label: "Sreenidhi College of Arts and Sciences (TELANGANA)" },
    { value: "Vasavi College of Arts and Sciences", label: "Vasavi College of Arts and Sciences (TELANGANA)" },
    { value: "Vignan's College of Arts and Sciences", label: "Vignan's College of Arts and Sciences (TELANGANA)" },
    { value: "Woxsen University College of Arts and Sciences", label: "Woxsen University College of Arts and Sciences (TELANGANA)" },
