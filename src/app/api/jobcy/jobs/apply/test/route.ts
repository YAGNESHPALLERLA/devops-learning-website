...
export async function POST(// request: NextRequest) {
  try {
    ...
    console.log('🚀 WORKING: Job application request for job:', jobId);
    ...
    console.log('🚀 WORKING: Application created:', result.insertedId);
    ...
    console.error('🚀 WORKING: Job application error:', error);
