...
export default function JobsPortal() {
  const [isDark, setIsDark] = useState(true); // Default to dark to match OneHubGlobal theme
  ...
  return (
    <div className={`min-h-screen ${isDark ? "bg-[#1a1a1a]" : "bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50"}`}>
      {/* Header */}
      <header className={`${isDark ? "bg-[#252525]/95 backdrop-blur-sm border-gray-700" : "bg-white/95 backdrop-blur-sm border-slate-200"} border-b sticky top-0 z-50 shadow-lg`}>
        <div className="px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className={`text-2xl font-bold ${isDark ? "text-white" : "text-slate-900"}`}>Jobcy Portal</h1>
                <p className={`text-sm ${isDark ? "text-gray-400" : "text-slate-600"}`}>by OneHubGlobal</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3">
              <Link
                ...
                className={`px-6 py-3 rounded-xl font-semibold transition-all duration-300 ${
                  isDark ? "bg-gray-700 text-gray-300 hover:bg-gray-600 hover:scale-105" : "bg-slate-100 text-slate-700 hover:bg-slate-200 hover:scale-105"
                } shadow-md`}
              >
                ← Back to Home
              </Link>
              <button
                ...
                className={`p-3 rounded-xl transition-all duration-300 ${
                  isDark ? "bg-gray-700 text-yellow-400 hover:bg-gray-600 hover:scale-105" : "bg-slate-100 text-slate-600 hover:bg-slate-200 hover:scale-105"
                } shadow-md`}
        ...
        <div className="relative flex items-center justify-center px-6 py-20">
          <div className="w-full max-w-7xl">
            <div className="text-center mb-16">
              <div className={`inline-flex items-center space-x-2 px-4 py-2 rounded-full mb-6 ${isDark ? "bg-gradient-to-r from-blue-900/30 to-purple-900/30" : "bg-gradient-to-r from-blue-100 to-purple-100"}`}>
              ...
              <p className={`text-xl md:text-2xl mb-10 ${isDark ? "text-gray-400" : "text-slate-600"} max-w-3xl mx-auto leading-relaxed`}>
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-12">
                <button
                  onClick={() => alert('Job Seeker Portal - Coming Soon!')}
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-20">
              <div className={`text-center p-8 rounded-2xl ${isDark ? "bg-[#252525]/50" : "bg-white/70"} backdrop-blur-sm shadow-xl border ${isDark ? "border-gray-700" : "border-slate-200"} hover:scale-105 transition-transform duration-300`}>
                ...
                <div className={`text-sm font-medium ${isDark ? "text-gray-400" : "text-slate-600"}`}>Active Jobs</div>
              </div>
              ...
              <div className={`text-center p-8 rounded-2xl ${isDark ? "bg-[#252525]/50" : "bg-white/70"} backdrop-blur-sm shadow-xl border ${isDark ? "border-gray-700" : "border-slate-200"} hover:scale-105 transition-transform duration-300`}>
                ...
                <div className={`text-sm font-medium ${isDark ? "text-gray-400" : "text-slate-600"}`}>Companies</div>
              </div>
              ...
              <div className={`text-center p-8 rounded-2xl ${isDark ? "bg-[#252525]/50" : "bg-white/70"} backdrop-blur-sm shadow-xl border ${isDark ? "border-gray-700" : "border-slate-200"} hover:scale-105 transition-transform duration-300`}>
                ...
                <div className={`text-sm font-medium ${isDark ? "text-gray-400" : "text-slate-600"}`}>Job Seekers</div>
              </div>
              ...
              <div className={`text-center p-8 rounded-2xl ${isDark ? "bg-[#252525]/50" : "bg-white/70"} backdrop-blur-sm shadow-xl border ${isDark ? "border-gray-700" : "border-slate-200"} hover:scale-105 transition-transform duration-300`}>
                ...
                <div className={`text-sm font-medium ${isDark ? "text-gray-400" : "text-slate-600"}`}>Success Rate</div>
              </div>
            </div>

            {/* Features */}
            <div className="grid md:grid-cols-3 gap-8 mb-20">
              <div className={`text-center p-8 rounded-2xl ${isDark ? "bg-[#252525]/50" : "bg-white/70"} backdrop-blur-sm shadow-xl border ${isDark ? "border-gray-700" : "border-slate-200"} hover:scale-105 transition-all duration-300`}>
            ...
            {/* Testimonials */}
            <div className={`text-center p-12 rounded-3xl ${isDark ? "bg-[#252525]/30" : "bg-white/50"} backdrop-blur-sm shadow-2xl border ${isDark ? "border-gray-700" : "border-slate-200"}`}>
              <h2 className={`text-3xl font-bold mb-8 ${isDark ? "text-white" : "text-slate-900"}`}>
                What Our Users Say
              </h2>

              <div className="max-w-4xl mx-auto">
                <div className={`p-8 rounded-2xl ${isDark ? "bg-[#252525]" : "bg-white"} shadow-lg`}>
                  <div className="flex items-center justify-center mb-4">
                    {[...Array(testimonials[currentTestimonial].rating)].map((_, i) => (
                      <Star key={i} className="w-5 h-5 text-yellow-400 fill-current" />
                    ))}
                  </div>
                  <blockquote className={`text-lg italic mb-6 ${isDark ? "text-gray-300" : "text-slate-700"}`}>
                    &quot;{testimonials[currentTestimonial].content}&quot;
                  </blockquote>
                  <div className="flex items-center justify-center space-x-4">
                    <div className={`w-12 h-12 rounded-full ${isDark ? "bg-gray-700" : "bg-slate-200"} flex items-center justify-center font-bold ${isDark ? "text-white" : "text-slate-900"}`}>
      ...
      {/* Footer */}
      <footer className={`${isDark ? "bg-[#252525]/95 backdrop-blur-sm border-gray-700" : "bg-white/95 backdrop-blur-sm border-slate-200"} border-t mt-20`}>
        <div className="px-6 py-12">
          <div className="max-w-6xl mx-auto">
            ...
            {/* Portal Links */}
            <div className={`mt-8 p-6 ${isDark ? "bg-gray-700/50" : "bg-gradient-to-r from-blue-50 to-purple-50"} rounded-xl`}>
              <h4 className={`font-semibold mb-4 text-center ${isDark ? "text-white" : "text-slate-900"}`}>Access Portals - Coming Soon!</h4>
              <div className="flex flex-wrap justify-center gap-3">
                <button
                  onClick={() => alert('Job Seeker Portal - Coming Soon!')}
                  className={`px-4 py-2 rounded-lg font-medium transition-all ${isDark ? "bg-gray-600 text-gray-200 hover:bg-gray-500" : "bg-white text-slate-700 hover:bg-slate-50"} shadow-sm hover:shadow-md`}
                >
                  Job Seeker Portal
                </button>
                <button
                  onClick={() => alert('HR Portal - Coming Soon!')}
                  className={`px-4 py-2 rounded-lg font-medium transition-all ${isDark ? "bg-gray-600 text-gray-200 hover:bg-gray-500" : "bg-white text-slate-700 hover:bg-slate-50"} shadow-sm hover:shadow-md`}
                >
                  HR Portal
                </button>
                <button
                  onClick={() => alert('Company Portal - Coming Soon!')}
                  className={`px-4 py-2 rounded-lg font-medium transition-all ${isDark ? "bg-gray-600 text-gray-200 hover:bg-gray-500" : "bg-white text-slate-700 hover:bg-slate-50"} shadow-sm hover:shadow-md`}
                >
                  Company Portal
                </button>
                <button
                  onClick={() => alert('Admin Portal - Coming Soon!')}
                  className={`px-4 py-2 rounded-lg font-medium transition-all ${isDark ? "bg-gray-600 text-gray-200 hover:bg-gray-500" : "bg-white text-slate-700 hover:bg-slate-50"} shadow-sm hover:shadow-md`}
                >
                  Admin Portal
                </button>
            ...
            <div className={`border-t ${isDark ? "border-gray-700" : "border-slate-200"} pt-8 text-center`}>
              <p className={`text-sm ${isDark ? "text-gray-400" : "text-slate-600"}`}>
                © 2024 Jobcy by OneHubGlobal. All rights reserved. Connecting talent with opportunity worldwide.
              </p>
            </div>
          </div>
        </div>
