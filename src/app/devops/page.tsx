    ...
    switch (activeSection) {
                ...
                <div className="bg-gradient-to-r from-blue-900/20 to-purple-900/20 p-8 rounded-2xl border border-blue-500/30 mb-8">
                  ...
                  <div className="bg-gray-800 p-6 rounded-xl">
                    ...
                    <ul className="text-gray-300 space-y-2">
                      ...
                      <li>• <strong className="text-white">Automation Mastery:</strong> Build robust CI/CD pipelines and infrastructure automation</li>
                      <li>• <strong className="text-white">Tool Proficiency:</strong> Master industry-standard DevOps tools and platforms</li>
                      <li>• <strong className="text-white">Real-World Application:</strong> Apply DevOps principles to solve actual business problems</li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-r from-gray-800/80 to-gray-900/80 p-8 rounded-2xl border border-gray-600 mb-8">
                  ...
                  <div className="space-y-8">
                    ...
                    <div className="bg-blue-900/20 border border-blue-500/30 p-6 rounded-xl">
                      <h3 className="text-2xl font-bold text-white mb-4">🔍 DevOps Definition & Evolution</h3>
                    ...
                    <div className="bg-green-900/20 border border-green-500/30 p-6 rounded-xl">
                      <h3 className="text-2xl font-bold text-white mb-4">💡 Why DevOps Matters in Today's Digital World</h3>
                      <p className="text-lg text-gray-300 mb-4">
              ...
              <div className="max-w-6xl mx-auto">
                ...
                <div className="bg-gray-800 p-8 rounded-2xl mb-8">
                  ...
                  <div className="bg-blue-900/20 border border-blue-500/30 p-6 rounded-xl mb-6">
                    <h3 className="text-2xl font-bold text-white mb-4">🚀 The First Way: Flow (Systems Thinking)</h3>
                    <p className="text-lg text-gray-300 mb-4">
                  ...
                  <div className="bg-green-900/20 border border-green-500/30 p-6 rounded-xl mb-6">
                    <h3 className="text-2xl font-bold text-white mb-4">🔄 The Second Way: Feedback (Amplify Feedback Loops)</h3>
                    <p className="text-lg text-gray-300 mb-4">
                  ...
                  <div className="bg-purple-900/20 border border-purple-500/30 p-6 rounded-xl">
                    <h3 className="text-2xl font-bold text-white mb-4">🧠 The Third Way: Continual Learning (Culture of Experimentation)</h3>
                    <p className="text-lg text-gray-300 mb-4">
              ...
              <div className="max-w-6xl mx-auto">
                ...
                <div className="bg-gradient-to-r from-gray-800/80 to-gray-900/80 p-8 rounded-2xl border border-gray-600 mb-8 hover-lift hover:ring-2 hover:ring-blue-500/30 hover:ring-opacity-50 transition-all duration-300">
                  ...
                  <div className="space-y-6">
                    <div className="bg-rose-900/30 border border-rose-500/30 p-4 rounded-lg text-center">
      ...
      case 'automation':
        return (
          <main>
            <div className="animate-fade-in-up">
              <h1 id="automation" className="text-4xl md:text-5xl font-extrabold mb-8 text-center">
              ...
              <div className="max-w-6xl mx-auto">
                ...
                <div className="bg-gradient-to-r from-blue-900/20 to-purple-900/20 p-8 rounded-2xl mb-8">
                  <h2 className="text-3xl font-bold text-white mb-6">🎯 The Automation Mindset</h2>
                  <p className="text-lg text-gray-300 mb-6">
                ...
                {/* Orchestration */}
                <div className="bg-gray-800 p-8 rounded-2xl mb-8">
                  <h2 className="text-3xl font-bold text-white mb-6">🎼 Orchestration: Conducting the Symphony</h2>
                  <p className="text-lg text-gray-300 mb-6">
      ...
      case 'security':
        return (
          <main>
            <div className="animate-fade-in-up">
              <h1 id="security" className="text-4xl md:text-5xl font-extrabold mb-8 text-center">
                🔒 DevSecOps & Security
              </h1>
              <p className="text-lg text-gray-400 mb-8 text-center">
              ...
              <div className="max-w-6xl mx-auto">
                ...
                <div className="bg-gradient-to-r from-red-900/20 to-orange-900/20 p-8 rounded-2xl mb-8">
                  <h2 className="text-3xl font-bold text-white mb-6">🛡️ DevSecOps: Security as Code</h2>
                  <p className="text-lg text-gray-300 mb-6">
                ...
                {/* Security in CI/CD */}
                <div className="bg-gray-800 p-8 rounded-2xl mb-8">
                  <h2 className="text-3xl font-bold text-white mb-6">🔐 Security in CI/CD Pipelines</h2>
                  <p className="text-lg text-gray-300 mb-6">
      ...
      case 'cloud-platforms':
        return (
          <main>
            <div className="animate-fade-in-up">
              <h1 id="cloud-platforms" className="text-4xl md:text-5xl font-extrabold mb-8 text-center">
              ...
              <div className="max-w-6xl mx-auto">
                ...
                <div className="bg-gradient-to-r from-blue-900/20 to-cyan-900/20 p-8 rounded-2xl mb-8">
                  <h2 className="text-3xl font-bold text-white mb-6">☁️ Cloud-Native DevOps</h2>
                  <p className="text-lg text-gray-300 mb-6">
          ...
          <main>
            <div className="animate-fade-in-up">
              ...
              <div className="max-w-6xl mx-auto">
                ...
                <div className="bg-gradient-to-r from-blue-900/20 to-purple-900/20 p-8 rounded-2xl mb-8">
                  <h2 className="text-3xl font-bold text-white mb-6">🛠️ The DevOps Toolchain Landscape</h2>
                  <p className="text-lg text-gray-300 mb-6">
                ...
                {/* Version Control */}
                <div className="bg-gray-800 p-8 rounded-2xl mb-8">
                  <h2 className="text-3xl font-bold text-white mb-6">🔀 Version Control Systems</h2>
                  <p className="text-lg text-gray-300 mb-6">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="bg-gray-700 p-6 rounded-xl">
                      <h3 className="text-xl font-bold text-white mb-4">🐙 Git - The Industry Standard</h3>
                ...
                {/* CI/CD Tools */}
                <div className="bg-gray-800 p-8 rounded-2xl mb-8">
                  <h2 className="text-3xl font-bold text-white mb-6">🔄 CI/CD Pipeline Tools</h2>
                  <p className="text-lg text-gray-300 mb-6">
                ...
                <div className="bg-gray-800 p-8 rounded-2xl mb-8">
                  <h2 className="text-3xl font-bold text-white mb-6">🐳 Containerization & Orchestration</h2>
                  <p className="text-lg text-gray-300 mb-6">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="bg-gray-700 p-6 rounded-xl">
                      <h3 className="text-xl font-bold text-blue-400 mb-4">🐳 Docker - Container Runtime</h3>
                      <ul className="text-gray-300 space-y-2 text-sm mb-4">
                    ...
                    <div className="bg-gray-700 p-6 rounded-xl">
                      <h3 className="text-xl font-bold text-purple-400 mb-4">☸️ Kubernetes - Orchestration Leader</h3>
                      <ul className="text-gray-300 space-y-2 text-sm mb-4">
                ...
                {/* Infrastructure as Code */}
                <div className="bg-gray-800 p-8 rounded-2xl mb-8">
                  <h2 className="text-3xl font-bold text-white mb-6">🏗️ Infrastructure as Code (IaC) Tools</h2>
                  <p className="text-lg text-gray-300 mb-6">
                  ...
                  <div className="space-y-4">
                    <div className="bg-gray-700 p-6 rounded-xl">
                      <h3 className="text-xl font-bold text-white mb-4">🔷 Terraform - Multi-Cloud IaC</h3>
                      <div className="grid md:grid-cols-2 gap-6">
                        <div>
                          <ul className="text-gray-300 space-y-2 text-sm">
                    ...
                    <div className="bg-gray-700 p-6 rounded-xl">
                      <h3 className="text-xl font-bold text-purple-400 mb-4">📜 Ansible - Configuration Management</h3>
                      <div className="grid md:grid-cols-2 gap-6">
                        <div>
                          <ul className="text-gray-300 space-y-2 text-sm">
                ...
                {/* Monitoring Tools */}
                <div className="bg-gray-800 p-8 rounded-2xl mb-8">
                  <h2 className="text-3xl font-bold text-white mb-6">📊 Monitoring & Observability Tools</h2>
                  <p className="text-lg text-gray-300 mb-6">
          ...
          <main>
            <div className="animate-fade-in-up">
              ...
              <div className="max-w-6xl mx-auto">
                ...
                {/* Foundation Phase */}
                <div className="bg-gray-800 p-8 rounded-2xl mb-8">
                  <h2 className="text-3xl font-bold text-white mb-6">🏗️ Phase 1: Foundation (Months 1-3)</h2>
                  <p className="text-lg text-gray-300 mb-6">
                  ...
                  <div className="space-y-6">
                    <div className="bg-gray-700 p-6 rounded-xl">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          <h3 className="text-xl font-bold text-white mb-3">🐧 Linux Fundamentals</h3>
                          <p className="text-gray-300 mb-4">
                    ...
                    <div className="bg-gray-700 p-6 rounded-xl">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          <h3 className="text-xl font-bold text-white mb-3">🔀 Version Control with Git</h3>
                          <p className="text-gray-300 mb-4">
                    ...
                    <div className="bg-gray-700 p-6 rounded-xl">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          <h3 className="text-xl font-bold text-white mb-3">🌐 Networking Fundamentals</h3>
                          <p className="text-gray-300 mb-4">
                ...
                {/* Intermediate Phase */}
                <div className="bg-gray-800 p-8 rounded-2xl mb-8">
                  <h2 className="text-3xl font-bold text-white mb-6">⚡ Phase 2: Intermediate Skills (Months 4-6)</h2>
                  <p className="text-lg text-gray-300 mb-6">
                  ...
                  <div className="space-y-6">
                    <div className="bg-gray-700 p-6 rounded-xl">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          <h3 className="text-xl font-bold text-white mb-3">🐳 Docker & Containerization</h3>
                          <p className="text-gray-300 mb-4">
                    ...
                    <div className="bg-gray-700 p-6 rounded-xl">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          <h3 className="text-xl font-bold text-white mb-3">🏗️ Infrastructure as Code</h3>
                          <p className="text-gray-300 mb-4">
                ...
                {/* Advanced Phase */}
                <div className="bg-gray-800 p-8 rounded-2xl mb-8">
                  <h2 className="text-3xl font-bold text-white mb-6">🚀 Phase 3: Advanced Topics (Months 7-12)</h2>
                  <p className="text-lg text-gray-300 mb-6">
                  ...
                  <div className="space-y-6">
                    <div className="bg-gray-700 p-6 rounded-xl">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          <h3 className="text-xl font-bold text-white mb-3">☸️ Kubernetes & Container Orchestration</h3>
                          <p className="text-gray-300 mb-4">
                    ...
                    <div className="bg-gray-700 p-6 rounded-xl">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          <h3 className="text-xl font-bold text-white mb-3">📊 Monitoring & Observability</h3>
                          <p className="text-gray-300 mb-4">
                    ...
                    <div className="bg-gray-700 p-6 rounded-xl">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          <h3 className="text-xl font-bold text-white mb-3">☁️ Cloud Platforms & Services</h3>
                          <p className="text-gray-300 mb-4">
                ...
                <div className="bg-gradient-to-r from-purple-900/20 to-pink-900/20 p-8 rounded-2xl mb-8">
                  <h2 className="text-3xl font-bold text-white mb-6">🎯 Specialization & Career Growth</h2>
                  <p className="text-lg text-gray-300 mb-6">
                ...
                {/* Resources & Community */}
                <div className="bg-gray-800 p-8 rounded-2xl">
                  <h2 className="text-3xl font-bold text-white mb-6">📚 Essential Resources & Community</h2>
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="bg-gray-700 p-6 rounded-xl">
