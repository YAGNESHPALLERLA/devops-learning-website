    ...
    <DocsLayout onThisPage={pageHeadings}>
      <div className="animate-fade-in-up">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <h2 id="key-concepts" className="text-3xl font-bold text-blue-400 mb-8">1. Key Concepts in DevOps</h2>
          ...
          <h2 id="devops-lifecycle" className="text-3xl font-bold text-blue-400 mb-6">2. The Infinite DevOps Lifecycle</h2>
          ...
          <h2 id="why-infinite" className="text-3xl font-bold text-blue-400 mb-6">3. Why is the DevOps Lifecycle Infinite?</h2>
